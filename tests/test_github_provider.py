...
class GitHubProviderTests(unittest.TestCase):
    def test_missing_repository_is_created_as_private(self) -> None:
        ...
        self.assertEqual(
            client.request.call_args_list[2].args,
            ("POST", "/user/repos", {"name": "payment-api", "private": True}),
        )
    ...
    def test_member_invitation_uses_username_and_permission(self) -> None:
        ...
        client.invite_member(
            github.GitHubMember("software-engineer", "octocat", "push")
        )
        ...
        self.assertEqual(
            ...
            (
                "PUT",
                "/repos/duanribeiro/payment-api/collaborators/octocat",
                {"permission": "push"},
            ),
        )
